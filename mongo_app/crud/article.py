...
async def is_article_favorited_by_user(conn: AsyncIOMotorClient, slug: str, username: str) -> bool:
...
async def get_article_by_slug(conn: AsyncIOMotorClient, slug: str, username: Optional[str] = None) -> ArticleInDB:
...
async def create_article_by_slug(conn: AsyncIOMotorClient, article: ArticleInCreate, username: str) -> ArticleInDB:
